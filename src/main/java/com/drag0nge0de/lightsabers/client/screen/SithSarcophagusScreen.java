...
public class SithSarcophagusScreen extends HandledScreen<SithSarcophagusScreenHandler> {

    private static final Identifier TEXTURE = Identifier.of("minecraft", "textures/gui/container/generic_54.png");
    private static final int ROWS = 3;

    public SithSarcophagusScreen(SithSarcophagusScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawForeground(net.minecraft.client.gui.DrawContext context, int mouseX, int mouseY) {
        ...
        context.drawText(this.textRenderer, Text.translatable("container.inventory"), this.playerInventoryTitleX,
